    ...
    <div class="box-heading">
        ...
        <div class="box-breadcrumb">
            <div class="breadcrumbs">
                <ul>
                    <li> <a class="icon-home" href="index.html">Annonce</a></li>
                    <li><span>Ajoute d'Annonce</span></li>
                </ul>
            </div>
        </div>
    </div>
                                ...
                                <div class="container">
                                    <div class="panel-white mb-30">
                                        <div class="box-padding bg-postjob">
                                            <h5 class="icon-edu">Fait une Annonce</h5>
                                            <div class="row mt-30">
                                                <div class="col-lg-9">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group mb-30">
                                                                <label class="font-sm color-text-mutted mb-10"> description detaillée de l'Annonce *</label>
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="form-group mb-30">
                                                                ...
                                                                <input class="form-control" type="text" placeholder="Nombre de vehicule disponible pour l'Annonce">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="form-group mb-30">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group mt-10">
                                                                <button class="btn btn-default btn-brand icon-tick">Ajouter nouvelle Annonce</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
